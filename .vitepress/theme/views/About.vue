  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 深海</span>
        <span class="text3">是一名 平平无奇的人、兴趣开发者、学生、GitHub搬运工</span>
      </div>
      <!-- 追求 -->
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">平平无奇 · 平平无奇的人</span>
          <span class="list-item" style="--color: #eb372a">GitHub · GitHub搬运工</span>
        </div>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item">
        ...
        <span class="title1" style="margin-top: 20px">生命不息，</span>
        <span class="title2">折腾不止。</span>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 1fr 1fr">
      ...
      >
        <div class="image-content">
          ...
          <div class="image-desc">
            <span class="left">手机、电脑及软硬件、还有magisk之神</span>
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">欧美、华语流行、纯音乐、热梗音乐</span>
          <div class="image-desc">
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      >
        <div class="image-content">
          <span class="tip">游戏</span>
          <span class="title2">塞尔达传说</span>
      ...
      <div class="about-item child">
        ...
        >
          <span class="position">我现在住在 <strong>中国，辽宁省</strong></span>
        </div>
        <div class="about-item info">
          <div class="info-item">
            <span class="info-name">生于</span>
            <span class="info-num" style="--color: #43a6c6">2013</span>
          </div>
          <div class="info-item">
            <span class="info-name">现在职业</span>
            <span class="info-num" style="--color: #dfac46">一只学生</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        ...
        <p class="text">
          这里大多都是<strong>搞笑向</strong>的文章，可能不太会有很多人看，权当是做个自我记录吧。当然，如果某篇文章能够帮助到你，那我也是很开心的。
        </p>
        <p class="text">
